...
import { readEnv as readEnv2 } from "openai/core";
...
var WrappedBetaChat = class extends Chat {
  constructor(client) {
    super(client);
    this.completions = new WrappedBetaCompletions(client);
  }
};
var WrappedBetaCompletions = class extends Completions {
  constructor(client) {
    super(client);
  }
  parse(body, options) {
...
var OpenAI2 = class extends openai.OpenAI {
  constructor({ openpipe, ...options } = {}) {
    super({
      ...options,
      apiKey: options.apiKey || readEnv2("OPENAI_API_KEY") || MISSING_OPENAI_API_KEY
    });
